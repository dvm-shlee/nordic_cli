...
This repository contains a python function and ~~command-line interface (CLI) tool written in Python~~ for executing functions of the NIFTI_NORDIC without MATLAB. The addition of python wrapper are made under the terms of the original license, and the software is intended for educational and research purposes only.
